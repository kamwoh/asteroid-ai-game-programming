...
class Player(Component):
    ...
    def move(self):
        ...
        if self._boosting:
            new_vx = (self.speed * math.sin(self.angle)) + (Player.BOOSTER_ACCELERATION * math.sin(self.rotation))
            new_vy = (self.speed * math.cos(self.angle)) + (Player.BOOSTER_ACCELERATION * math.cos(self.rotation))
